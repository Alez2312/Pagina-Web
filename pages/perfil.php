...
<body>
    ...
    <div class="container_table">
        ...
        while ($row = mysqli_fetch_assoc($resultado)) {
            $consultaValidarPerfil = "SELECT * FROM usuario WHERE cod_perfil = '" . $row['cod_perfil'] . "'";
            $resultadoValidarPerfil = mysqli_query($conexion, $consultaValidarPerfil);
            $numFilas = mysqli_num_rows($resultadoValidarPerfil);
        ?>
